...
class WeatherVC: UIViewController {
    ...
    private let statusLabel:UILabel = {
        ...
        labl.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
    ...
    private let lastUpdateLabel:UILabel = {
        ...
        //labl.backgroundColor = #colorLiteral(red: 0.9607843161, green: 0.7058823705, blue: 0.200000003, alpha: 1)
        labl.layer.masksToBounds = true
    ...
    override func viewDidLoad() {
        ...
        bckimage.image = UIImage(named: "bg17.jpg")
    ...
    override func viewDidLayoutSubviews() {
        ...
        updateLabel.frame = CGRect(x: 20, y: uvLabel.bottom + 30, width: view.width - 230, height: 30)
        lastUpdateLabel.frame = CGRect(x: updateLabel.width + 20, y: uvLabel.bottom + 30, width: view.width - 80, height: 30)
